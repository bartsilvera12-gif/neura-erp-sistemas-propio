...
export async function PATCH(
  ...
  try {
    ...
    // Cobranzas y el motor de facturación clasifican por este campo; la suscripción ya no
    // lleva tipo. Por eso NO hay que sincronizar nada hacia `suscripciones` al editar el cliente.
