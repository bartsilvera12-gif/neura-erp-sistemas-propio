...
const DASH_SLUGS = new Set(["comercial", "financiero", "inventario", "ventas", "proyectos"]);
export type DashboardTabSlug = "comercial" | "financiero" | "inventario" | "ventas" | "proyectos";
