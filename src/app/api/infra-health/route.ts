 ...
 *
 * Acceso: el mismo correo que ve el módulo "Panel de Control". Se comprueba acá
 * además de en la página, porque saber la URL no es un permiso.
 */
...
export async function GET(request: Request) {
  ...
  if (!puedeVerPanelControl(user.email)) {
