-- ============================================================================
-- Notificación de comentario en un proyecto.
--
-- Amplía `chk_unotif_tipo` con el tipo que emiten los comentarios de proyecto:
--   * `comentario_proyecto` — alguien dejó un comentario en la solapa
--     Comentarios de un proyecto. El destinatario depende del canal y del rol
--     del autor (ver src/lib/proyectos/comentario-notificaciones.ts).
--
...
BEGIN
  ...
  LOOP
    ...
    RAISE NOTICE 'Schema %: chk_unotif_tipo ampliado con comentario_proyecto.', sch;
  END LOOP;
END $$;
